...
$(function () {
    function EEPROMMarlinViewModel(parameters) {
        ...
        self.eeprom = (function () {
            ...
            eeprom.from_dict = function (data) {
                // advanced
                eeprom.advanced.B(data.eeprom.advanced.B);
                eeprom.advanced.E(data.eeprom.advanced.E);
                eeprom.advanced.S(data.eeprom.advanced.S);
                eeprom.advanced.T(data.eeprom.advanced.T);
                eeprom.advanced.X(data.eeprom.advanced.X);
                eeprom.advanced.Y(data.eeprom.advanced.Y);
                eeprom.advanced.Z(data.eeprom.advanced.Z);
                // autolevel
                eeprom.autolevel.S(data.eeprom.autolevel.S);
                eeprom.autolevel.Z(data.eeprom.autolevel.Z);
                // bed_pid
                eeprom.bed_pid.D(data.eeprom.bed_pid.D);
                eeprom.bed_pid.I(data.eeprom.bed_pid.I);
                eeprom.bed_pid.P(data.eeprom.bed_pid.P);
                // delta
                eeprom.delta.A(data.eeprom.delta.A);
                eeprom.delta.B(data.eeprom.delta.B);
                eeprom.delta.C(data.eeprom.delta.C);
                eeprom.delta.L(data.eeprom.delta.L);
                eeprom.delta.R(data.eeprom.delta.R);
                eeprom.delta.S(data.eeprom.delta.S);
                // endstop
                eeprom.endstop.X(data.eeprom.endstop.X);
                eeprom.endstop.Y(data.eeprom.endstop.Y);
                eeprom.endstop.Z(data.eeprom.endstop.Z);
                // feedrate
                eeprom.feedrate.E(data.eeprom.feedrate.E);
                eeprom.feedrate.X(data.eeprom.feedrate.X);
                eeprom.feedrate.Y(data.eeprom.feedrate.Y);
                eeprom.feedrate.Z(data.eeprom.feedrate.Z);
                // filament
                eeprom.filament.D(data.eeprom.filament.D);
                // hotend_pid
                eeprom.hotend_pid.D(data.eeprom.hotend_pid.D);
                eeprom.hotend_pid.I(data.eeprom.hotend_pid.I);
                eeprom.hotend_pid.P(data.eeprom.hotend_pid.P);
                // linear
                eeprom.linear.K(data.eeprom.linear.K);
                eeprom.linear.R(data.eeprom.linear.R);
                // max_acceleration
                eeprom.max_acceleration.E(data.eeprom.max_acceleration.E);
                eeprom.max_acceleration.X(data.eeprom.max_acceleration.X);
                eeprom.max_acceleration.Y(data.eeprom.max_acceleration.Y);
                eeprom.max_acceleration.Z(data.eeprom.max_acceleration.Z);
                // print_acceleration
                eeprom.print_acceleration.P(data.eeprom.print_acceleration.P);
                eeprom.print_acceleration.R(data.eeprom.print_acceleration.R);
                eeprom.print_acceleration.T(data.eeprom.print_acceleration.T);
                // probe_offset
                eeprom.probe_offset.X(data.eeprom.probe_offset.X);
                eeprom.probe_offset.Y(data.eeprom.probe_offset.Y);
                eeprom.probe_offset.Z(data.eeprom.probe_offset.Z);
                // steps
                eeprom.steps.X(data.eeprom.steps.X);
                eeprom.steps.Y(data.eeprom.steps.Y);
                eeprom.steps.Z(data.eeprom.steps.Z);
                eeprom.steps.E(data.eeprom.steps.E);
            };

            eeprom.to_dict = function () {
